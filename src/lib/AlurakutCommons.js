...
import ButtonThemeModes from '../components/ButtonThemeModes';
...
// Menu
// ================================================================================================================
export function AlurakutMenu({ github }) {
  ...
  return (
    <AlurakutMenu.Wrapper isMenuOpen={isMenuOpen}>
      ...
      <AlurakutMenuProfileSidebar github={github} />
    </AlurakutMenu.Wrapper>
  );
}
AlurakutMenu.Wrapper = styled.header`
  width: 100%;
  background-color: ${({ theme }) => theme.menu.backgroundPrimary};
  .alurakutMenuProfileSidebar {
    background: ${({ theme }) => theme.profileSidebarMenu.backgroundPrimary};
    position: fixed;
    z-index: 100;
    padding: 46px;
    bottom: 0;
    ...
    .boxLink {
      font-size: 18px;
      color: ${({ theme }) => theme.menu.boxLink};
    ...
    hr {
      ...
      border-bottom-color: ${({ theme }) => theme.menu.underLine};
    }
  }
  .container {
    background-color: ${({ theme }) => theme.menu.backgroundPrimary};
    ...
    nav {
      ...
      a {
        ...
        &:after {
          content: ' ';
          background-color: ${({ theme }) => theme.menu.separator};
          display: block;
          position: absolute;
          width: 1px;
          height: 12px;
    ...
    input {
      color: ${({ theme }) => theme.menu.inputText};
      background: ${({ theme }) => theme.menu.inputBackground};
      padding: 10px 42px;
      border: 0;
...
AlurakutMenu.Logo = styled.img`
  background-color: ${({ theme }) => theme.menu.logoBackground};
  padding: 9px 14px;
  border-radius: 1000px;
  height: 34px;
`;

function AlurakutMenuProfileSidebar({ github }) {
  return (
...
// AlurakutProfileSidebarMenuDefault
// ================================================================================================================
export function AlurakutProfileSidebarMenuDefault({ themeMode, setThemeMode }) {
  return (
    <AlurakutProfileSidebarMenuDefault.Wrapper>
      ...
      <hr />
      <nav>
        <ButtonThemeModes themeMode={themeMode} setThemeMode={setThemeMode} />
      </nav>
    </AlurakutProfileSidebarMenuDefault.Wrapper>
  );
}
AlurakutProfileSidebarMenuDefault.Wrapper = styled.div`
  a {
    font-size: 12px;
    color: ${({ theme }) => theme.profileSidebarMenu.text};
    margin-bottom: 16px;
    display: flex;
    align-items: center;
    justify-content: flex-start;
...
OrkutNostalgicIconSet.List = styled.ul`
  ...
  li {
    font-size: 12px;
    color: ${({ theme }) => theme.orkutNostalgicIconSet.text};
    display: grid;
    grid-template-areas:
      'title title'
      'number number';
